...
const categoriesList = [
  womenClothing, newClothingFashion, compAcces, automobile, kidstoys, sports, jwellery, furniture, cellphone
];
...
const ItemDetailsButtonList = [video, reviews, privacyPolicy, returnPolicy, sellerPolicy, supportPolicy];
